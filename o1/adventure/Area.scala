...
class Area(var name: String, var description: String) {
  ...
  var enemy: Option[Enemy] = None // Holds the enemy in the area
  ...
  def fullDescription = {
    if (this.items.nonEmpty) {
      if (this.enemy.nonEmpty) {
        val itemList = "\n\nItems here: " + this.items.keys.mkString(" ")
        val enemy = "\n\nEnemy here: " + this.enemy.get.name
        val exitList = "\n\nExits available: " + this.neighbors.keys.mkString(" ")
        this.description + itemList + enemy + exitList
      } else {
        val itemList = "\n\nItems here: " + this.items.keys.mkString(" ")
        val exitList = "\n\nExits available: " + this.neighbors.keys.mkString(" ")
      ...
      if (this.enemy.nonEmpty) {
        val exitList = "\n\nExits available: " + this.neighbors.keys.mkString(" ")
        val enemy = "\n\nEnemy here: " + this.enemy.get.name
        this.description + enemy + exitList
      } else {
        val exitList = "\n\nExits available: " + this.neighbors.keys.mkString(" ")
